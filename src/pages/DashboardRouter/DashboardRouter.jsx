...
const UploadSubscribes = lazy(() =>
  import("./UploadSubscribes/UploadSubscribes")
);

const RetirementExcel = lazy(() =>
  import("./RetirementExcel/RetirementExcel")
);
...
const Specializatio = lazy(() =>
  import("./Specializatio/Specializatio")
);

const UnitWorkPlace = lazy(() =>
  import("./UnitWorkPlace/UnitWorkPlace")
);
...
const AllSurgicalProced = lazy(() =>
  import("./AllSurgicalProced/AllSurgicalProced")
);

const AllHospital = lazy(() =>
  import("./AllHospital/AllHospital")
);

const AddClaims = lazy(() =>
  import("./AddClaims/AddClaims")
);

const AllClaims = lazy(() =>
  import("./AllClaims/AllClaims")
);

const AllEng = lazy(() =>
  import("./AllEng/AllEng")
);

const AllMember = lazy(() =>
  import("./AllMember/AllMember")
);

const AgePage = lazy(() =>
  import("./AgePage/AgePage")
);

const AllAges = lazy(() =>
  import("./ALLAges/ALLAges")
);
...
const AllRenewall = lazy(() =>
  import("./AllRenewall/AllRenewall")
);
...
const ManualClaims = lazy(() =>
  import("./ManualClaims/ManualClaims")
);

const AllClaimsManual = lazy(() =>
  import("./AllClaimsManual/AllClaimsManual")
);

const AnnualStudy = lazy(() =>
  import("./AnnualStudy/AnnualStudy")
);

const UploadManual = lazy(() =>
  import("./UploadManual/UploadManual")
);

const UploadUnits = lazy(() =>
  import("./UploadUnits/UploadUnits")
);

const UploadHospital = lazy(() =>
  import("./UploadHospital/UploadHospital")
);
...
const AllMemberR = lazy(() =>
  import("./AllMemberR/AllMemberR")
);

const SearchRE = lazy(() =>
  import("./SearchRE/SearchRE")
);

const RenewTest = lazy(() =>
  import("./RenewTest/RenewTest")
);

const Show = lazy(() =>
  import("./AgePage/Show/Show")
);
...
export default function DashboardRouter() {
  ...
  // إذا role غير موجود بعد، لا نعمل redirect مباشرة
  if (!role) {
    return <Spinner page />;
  }
  ...
  // المستخدم موجود لكن ليس لديه صلاحية
